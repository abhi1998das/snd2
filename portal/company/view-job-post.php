<?php
session_start();
if(empty($_SESSION['id_user'])||isset($_SESSION['userLogged'])) {
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="table-responsive">
            <h2 class="text-center">All Internship Posts</h2>
            <table class="table table-striped">
              ...
              <tbody>
                <?php 
                  $sql = "SELECT * FROM intern_post WHERE id_company='$_SESSION[id_user]'";
